...
module.exports.renderNewForm = async (req, res) => {
    const response = await axios.get("http://api.geonames.org/countryInfoJSON?lang=en&username=lakshay187");
    const countries = response.data.geonames.map(country => country.countryName);
    countries.sort();
